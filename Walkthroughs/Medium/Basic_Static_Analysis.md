...
Room link: [https://tryhackme.com/room/staticanalysis1](https://tryhackme.com/room/staticanalysis1)
...
![Flare VM Logo](Images/Flare_VM_Logo.png)
...
![Malware Strings Search](Images/Malware_Strings_Search.png)
...
![PEStudio Strings Search](Images/PEStudio_Strings_Search.png)
...
On the Desktop in the attached VM, there is a directory named 'mal' with malware samples 1 to 6. Use floss to identify obfuscated strings found in the samples named 2, 5, and 6.

#### Which of these samples contains the string 'DbgView.exe'?

Hint: Use floss to extract obfuscated strings. Floss can be executed from cmd after navigating to the C:\Users\Administrator\Desktop

```bat
C:\Users\Administrator\Desktop\mal>floss 2 | grep -i dbgview

FLARE Sun 01/04/2026  6:15:53.54
C:\Users\Administrator\Desktop\mal>floss 5 | grep -i dbgview

FLARE Sun 01/04/2026  6:16:13.83
C:\Users\Administrator\Desktop\mal>floss 6 | grep -i dbgview
...
FLARE Sun 01/04/2026  6:17:16.95
...
![Malware Example 1](Images/Malware_Example_1.png)
...
![PEStudio Imphash Example](Images/PEStudio_Imphash_Example.png)
...
![Malware Bazaar Imphash Search](Images/Malware_Bazaar_Imphash_Search.png)
...
```bash
FLARE Sun 01/04/2026  6:52:14.04
C:\Users\Administrator\Desktop\mal>..\ssdeep-2.14.1\ssdeep.exe -d -l -r C:\Users\Administrator\Desktop\mal
C:\Users\Administrator\Desktop\mal\3 matches C:\Users\Administrator\Desktop\mal\1 (93)

FLARE Sun 01/04/2026  6:52:56.73
C:\Users\Administrator\Desktop\mal>
```
...
![Malware Example 2](Images/Malware_Example_2.png)
...
```bash
C:\Users\Administrator\Desktop\mal>capa 4
loading : 100%|████████████████████████████████████████████████████████████| 485/485 [00:00<00:00, 1935.32     rules/s]
matching: 100%|████████████████████████████████████████████████████████████| 7123/7123 [01:36<00:00, 73.47 functions/s]
+------------------------+------------------------------------------------------------------------------------+
...
Using Powershell will help avoid cutting off the output. Use the -v or -vv flag to get very verbose output and write it into a file.
In the file, navigate to 'check HTTP status code' and find the text 'function @ ...........' where the dotted line represents the address.

```bash
C:\Users\Administrator\Desktop\mal>capa -v 4 > capa_analysis_4.txt
loading : 100%|████████████████████████████████████████████████████████████| 485/485 [00:00<00:00, 1939.92     rules/s]
matching: 100%|████████████████████████████████████████████████████████████| 7123/7123 [01:36<00:00, 73.98 functions/s]

FLARE Sun 01/04/2026  7:20:58.48
C:\Users\Administrator\Desktop\mal>grep -i -A5 "check http status code" capa_analysis_4.txt
...
![Malware Example 3](Images/Malware_Example_3.png)
...
![PEStudio Libraries Example](Images/PEStudio_Libraries_Example.png)

The functions option just below shows the functions imported from these libraries.

![PEStudio Functions Example](Images/PEStudio_Functions_Example.png)
...
Hint: Write the name of the dll file which has a cross mark in front of it in the blacklist column

![PEStudio Analysis 1](Images/PEStudio_Analysis_1.png)

Answer: `rpcrt4.dll`

#### What does this dll do?

Hint: Check the description column of the dll
...
- [FLOSS - GitHub](https://github.com/mandiant/flare-floss)
- [grep - Linux manual page](https://man7.org/linux/man-pages/man1/grep.1.html)
- [MalAPI - Homepage](https://malapi.io/)
...
- [Pestudio - Homepage](https://www.winitor.com/download)
...
- [ssdeep - Homepage](https://ssdeep-project.github.io/ssdeep/index.html)
- [ssdeep - Kali Tools](https://www.kali.org/tools/ssdeep/#ssdeep)
