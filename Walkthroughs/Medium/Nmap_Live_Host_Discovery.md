...
![Nmap Steps](Images/Nmap_Steps.png)
...
![Network Subnets Example](Images/Network_Subnets_Example.png)
...
You might want to refer to Task 2 in the [Intro to LAN room](https://tryhackme.com/room/introtolan) if you need to learn more about subnetting.
...
![Send Packet Example 1](Images/Send_Packet_Example_1.png)
...
![Send Packet Example 2](Images/Send_Packet_Example_2.png)
...
```bash
┌──(kali㉿kali)-[/mnt/…/TryHackMe/Walkthroughs/Medium/Nmap_Live_Host_Discovery]
└─$ nmap -sL -n 10.10.12.13/29
Starting Nmap 7.95 ( https://nmap.org ) at 2025-12-14 14:52 CET
...
On each subnet, Nmap will scan 125 - 101 + 1 = 25 hosts.

There are 256 subnets so in total Nmap will scan 256 * 25 = 6400 hosts.
...
![OSI and TCP/IP Model](Images/OSI_and_TCP_IP_Model.png)
...
![Nmap ARP Host Discovery](Images/Nmap_ARP_Host_Discovery.png)
...
![Nmap ARP Host Discovery 3](Images/Nmap_ARP_Host_Discovery_3.png)
...
![Nmap ICMP Host Discovery](Images/Nmap_ICMP_Host_Discovery.png)
...
![Nmap ICMP Host Discovery 2](Images/Nmap_ICMP_Host_Discovery_2.png)
...
![Nmap ICMP Host Discovery 3](Images/Nmap_ICMP_Host_Discovery_3.png)
...
![Nmap ICMP Host Discovery 4](Images/Nmap_ICMP_Host_Discovery_4.png)
...
![Nmap ICMP Host Discovery 5](Images/Nmap_ICMP_Host_Discovery_5.png)
...
![Nmap ICMP Host Discovery 6](Images/Nmap_ICMP_Host_Discovery_6.png)
...
![Nmap TCP Host Discovery](Images/Nmap_TCP_Host_Discovery.png)
...
![Nmap TCP Host Discovery 2](Images/Nmap_TCP_Host_Discovery_2.png)
...
![Nmap TCP Host Discovery 3](Images/Nmap_TCP_Host_Discovery_3.png)
...
![Nmap TCP Host Discovery 4](Images/Nmap_TCP_Host_Discovery_4.png)
...
![Nmap UDP Host Discovery](Images/Nmap_UDP_Host_Discovery.png)
...
![Nmap UDP Host Discovery 2](Images/Nmap_UDP_Host_Discovery_2.png)
...
- [Arp-scan - User Guide](https://github.com/royhills/arp-scan/wiki/arp-scan-User-Guide)
