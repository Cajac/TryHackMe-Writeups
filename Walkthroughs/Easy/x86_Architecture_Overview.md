...
Room link: [https://tryhackme.com/room/x8664arch](https://tryhackme.com/room/x8664arch)
...
![CPU Registers x86](Images/CPU_Registers_x86.png)
...
Hint: 32-bit registers have a prefix of 'E' before their 16-bit names.

Answer: `ECX`

#### Which registers from the ones discussed above are not present in a 32-bit system?

Hint: These registers were introduced in 64-bit systems.
...
![Memory Overview](Images/Memory_Overview.png)
...
![Stack Layout](Images/Stack_Layout.png)
...
Use the image above as a guide to solve the challenge.
...
Let us know what you think about this room on our [Discord channel](https://discord.gg/tryhackme) or [X (Twitter) account](http://x.com/tryhackme). See you around.
