...
Room link: [https://tryhackme.com/room/passiverecon](https://tryhackme.com/room/passiverecon)
...
```bash
┌──(kali㉿kali)-[/mnt/…/TryHackMe/Walkthroughs/Easy/Passive_Reconnaissance]
└─$ whois tryhackme.com
   Domain Name: TRYHACKME.COM
   Registry Domain ID: 2282723194_DOMAIN_COM-VRSN
   Registrar WHOIS Server: whois.namecheap.com
...
>>> Last update of whois database: 2025-12-14T10:29:46Z <<<
<---snip--->
```
...
See the `Creation Date` row in the output above.

Answer: `20180705`

#### What is the registrar of TryHackMe.com?

See the `Registrar WHOIS Server` and `Registrar URL` rows in the output above.

Answer: `namecheap.com`

#### Which company is TryHackMe.com using for name servers?

See the `Name Server` rows in the output above.
...
Server:         10.111.242.1
Address:        10.111.242.1#53

Non-authoritative answer:
thmlabs.com     text = "THM{<REDACTED>}"
...
; <<>> DiG 9.20.4-4-Debian <<>> thmlabs.com txt
;; global options: +cmd
;; Got answer:
...
;; ANSWER SECTION:
thmlabs.com.            275     IN      TXT     "THM{<REDACTED>}"

;; Query time: 7 msec
;; SERVER: 10.111.242.1#53(10.111.242.1) (UDP)
;; WHEN: Sun Dec 14 11:47:02 CET 2025
;; MSG SIZE  rcvd: 90
```
...
![DNSDumpster THM Results 1](Images/DNSDumpster_THM_Results_1.png)
...
![DNSDumpster THM Results 2](Images/DNSDumpster_THM_Results_2.png)
...
![DNSDumpster THM Results 3](Images/DNSDumpster_THM_Results_3.png)
...
![Shodan THM Results](Images/Shodan_THM_Results.png)
...
You may also try searching for the IP addresses you have obtained from DNS lookups. These are, of course, more subject to change. On their [help page](https://help.shodan.io/the-basics/search-query-fundamentals), you can learn about all the search options available at Shodan.io, and you are encouraged to join TryHackMe’s [Shodan.io room](https://tryhackme.com/room/shodan).
...
![Shodan.io Results 1](Images/Shodan.io_Results_1.png)
...
![Shodan.io Results 2](Images/Shodan.io_Results_2.png)
...
- [DNSDumpster - Homepage](https://dnsdumpster.com/)
