...
This room will cover the foundations of Network Security and Traffic analysis and introduce the essential concepts of these disciplines to help you step into Traffic/Packet Analysis. We suggest completing the [Network Fundamentals module](https://tryhackme.com/module/network-fundamentals) before starting working in this room.
...
Typical Network Security Management Operation is explained below:
...
Filter the traffic for the IPs:
...
Filter the traffic for the ports:
