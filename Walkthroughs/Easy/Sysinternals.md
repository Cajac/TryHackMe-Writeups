...
- **Machine IP**: `10.67.143.57`
- **User**: `administrator`
- **Password**: `letmein123!`

![Remote Desktop Example](Images/Remote_Desktop_Example.png)
...
![Sysinternals Homepage](Images/Sysinternals_Homepage.png)
...
![Sysinternals Process Tools](Images/Sysinternals_Process_Tools.png)
...
![Sysinternals Suite](Images/Sysinternals_Suite.png)
...
![System Properties Env vars 1](Images/System_Properties_Env_vars_1.png)

Select `Path` under `System Variables` and select Edit... then OK.

![System Properties Env vars 2](Images/System_Properties_Env_vars_2.png)
...
![System Properties Env vars 3](Images/System_Properties_Env_vars_3.png)

Open a new command prompt (elevated) to confirm that the Sysinternals Suite can be executed from any location.

![Sysinternals ProcMon](Images/Sysinternals_ProcMon.png)
...
![Sysinternals ProcMon 2](Images/Sysinternals_ProcMon_2.png)
...
![Sysinternals ProcMon 3](Images/Sysinternals_ProcMon_3.png)

The service needs to be started before attempting to call any Sysinternals tool in this fashion.

![Sysinternals ProcMon 4](Images/Sysinternals_ProcMon_4.png)

Verify it's running before proceeding.

![Sysinternals ProcMon 5](Images/Sysinternals_ProcMon_5.png)
...
![Sysinternals ProcMon 6](Images/Sysinternals_ProcMon_6.png)
...
![Sysinternals ProcMon 7](Images/Sysinternals_ProcMon_7.png)
...
![Sysinternals ProcMon 8](Images/Sysinternals_ProcMon_8.png)

**Method 2** - Run tool from a mapped drive

![Sysinternals ProcMon 9](Images/Sysinternals_ProcMon_9.png)

**Note**: The asterisk will auto-assign a drive letter. The asterick can be replaced with an actual drive letter instead.

![Sysinternals ProcMon 10](Images/Sysinternals_ProcMon_10.png)

The website is now browsable within the local machine.

![Sysinternals ProcMon 11](Images/Sysinternals_ProcMon_11.png)

![Sysinternals ProcMon 12](Images/Sysinternals_ProcMon_12.png)
...
![Sysinternals Sigcheck 1](Images/Sysinternals_Sigcheck_1.png)
...
![Sysinternals Sigcheck 2](Images/Sysinternals_Sigcheck_2.png)
...
![Sysinternals Streams 1](Images/Sysinternals_Streams_1.png)

Example: A file downloaded from the Internet.

![Sysinternals Streams 2](Images/Sysinternals_Streams_2.png)

Since the file has this identifier, additional security measures are added to its properties.

![Sysinternals Streams 3](Images/Sysinternals_Streams_3.png)
...
![DOD 5220.22-M Wipe](Images/DOD_5220.22-M_Wipe.png)

Source: [https://www.lifewire.com/dod-5220-22-m-2625856](https://www.lifewire.com/dod-5220-22-m-2625856)

SDelete has been used by adversaries and is associated with MITRE techniques [T1485](https://attack.mitre.org/techniques/T1485/) (**Data Destruction**) and [T1070.004](https://attack.mitre.org/techniques/T1070/004/) (**Indicator Removal on Host: File Deletion**). It's MITRE ID S0195.
...
There is a txt file on the desktop named `file.txt`.

#### Using one of the three discussed tools in this task, what is the text within the ADS?

![Streams ADS Analysis](Images/Streams_ADS_Analysis.png)
...
![Resource Monitor 1](Images/Resource_Monitor_1.png)

Expand **TCP Connections** to view the **Remote Address** for each **Process** with an outbound connection.

![Resource Monitor 2](Images/Resource_Monitor_2.png)

Now back to TCPView.

![Sysinternals TCPView 1](Images/Sysinternals_TCPView_1.png)

The below image shows the default view for TCPView.

![Sysinternals TCPView 2](Images/Sysinternals_TCPView_2.png)
...
![Sysinternals TCPView 3](Images/Sysinternals_TCPView_3.png)
...
![Sysinternals TCPView 4](Images/Sysinternals_TCPView_4.png)
...
![Sysinternals TCPView 5](Images/Sysinternals_TCPView_5.png)
...
- You can use a website like `https://www.whois.com/whois` to get the organization's name.
- Unfortunately, the answer provided by `https://talosintelligence.com/` is different and won't be accepted, although it is also correct.

```bash
┌──(kali㉿kali)-[/mnt/…/TryHackMe/Walkthroughs/Easy/Sysinternals]
└─$ whois 52.154.170.73
...
CIDR:           52.160.0.0/11, 52.146.0.0/15, 52.145.0.0/16, 52.148.0.0/14, 52.152.0.0/13
NetName:        MSFT
...
![Sysinternals Autoruns 1](Images/Sysinternals_Autoruns_1.png)
...
![Sysinternals Autoruns 2](Images/Sysinternals_Autoruns_2.png)
...
![Sysinternals Autoruns 3](Images/Sysinternals_Autoruns_3.png)
...
![Sysinternals ProcDump 1](Images/Sysinternals_ProcDump_1.png)
...
![Sysinternals ProcDump 2](Images/Sysinternals_ProcDump_2.png)
...
![Sysinternals Process Explorer 1](Images/Sysinternals_Process_Explorer_1.png)
...
![Sysinternals Process Explorer 2](Images/Sysinternals_Process_Explorer_2.png)
...
![Sysinternals Process Explorer 3](Images/Sysinternals_Process_Explorer_3.png)
...
![Sysinternals Process Explorer 4](Images/Sysinternals_Process_Explorer_4.png)
...
![Sysinternals Process Explorer 5](Images/Sysinternals_Process_Explorer_5.png)
...
![Sysinternals Process Explorer 6](Images/Sysinternals_Process_Explorer_6.png)
...
![Sysinternals Process Explorer 7](Images/Sysinternals_Process_Explorer_7.png)
...
![Sysinternals Process Monitor 1](Images/Sysinternals_Process_Monitor_1.png)
...
![Sysinternals Process Monitor 2](Images/Sysinternals_Process_Monitor_2.png)
...
![Sysinternals Process Monitor 3](Images/Sysinternals_Process_Monitor_3.png)
...
![Sysinternals Process Monitor 4](Images/Sysinternals_Process_Monitor_4.png)

To use ProcMon effectively you **must** use the Filter and **must** configure it properly.

![Sysinternals Process Monitor 5](Images/Sysinternals_Process_Monitor_5.png)
...
![Sysinternals PsExec 1](Images/Sysinternals_PsExec_1.png)
...
![Sysinternals Autoruns 4](Images/Sysinternals_Autoruns_4.png)
...
![Sysmon Room](Images/Sysmon_Room.png)
...
![Sysinternals WinObj 1](Images/Sysinternals_WinObj_1.png)

The below image shows the default view for WinObj.

![Sysinternals WinObj 2](Images/Sysinternals_WinObj_2.png)

Within Session 0, under `DosDevices`, there is an entry for the network drive I mounted in my local machine.

![Sysinternals WinObj 3](Images/Sysinternals_WinObj_3.png)

Let's look at `WindowStations` value for Session 1.

![Sysinternals WinObj 4](Images/Sysinternals_WinObj_4.png)
...
![Sysinternals Process Explorer 8](Images/Sysinternals_Process_Explorer_8.png)
...
![Sysinternals BgInfo 1](Images/Sysinternals_BgInfo_1.png)
...
![Sysinternals BgInfo 2](Images/Sysinternals_BgInfo_2.png)
...
![Sysinternals RegJump 1](Images/Sysinternals_RegJump_1.png)
...
![Sysinternals RegJump 2](Images/Sysinternals_RegJump_2.png)

![Sysinternals RegJump 3](Images/Sysinternals_RegJump_3.png)
...
![Sysinternals Strings 1](Images/Sysinternals_Strings_1.png)

Other tools fall under the **Miscellaneous** category. I encourage you to explore these tools at your own leisure.

Link: [https://docs.microsoft.com/en-us/sysinternals/downloads/misc-utilities](https://docs.microsoft.com/en-us/sysinternals/downloads/misc-utilities)
...
- [ProcDump - Homepage](https://learn.microsoft.com/en-us/sysinternals/downloads/procdump)
...
- [SDelete - Homepage](https://learn.microsoft.com/en-us/sysinternals/downloads/sdelete)
- [Sigcheck - Homepage](https://learn.microsoft.com/en-us/sysinternals/downloads/sigcheck)
- [Streams - Homepage](https://learn.microsoft.com/en-us/sysinternals/downloads/streams)
...
- [TCPView - Homepage](https://learn.microsoft.com/en-us/sysinternals/downloads/tcpview)
- [WinObj - Homepage](https://learn.microsoft.com/en-us/sysinternals/downloads/winobj)
