...
Room link: [https://tryhackme.com/room/introtok8s](https://tryhackme.com/room/introtok8s)
...
This room will continue the [DevSecOps path](https://tryhackme.com/path-action/devsecops/join), so all previous DevSecOps modules should be completed, especially the two rooms before this one in the [Container Security module](https://tryhackme.com/module/container-security) ([Intro to Containerisation](https://tryhackme.com/jr/introtocontainerisation) and [Intro to Docker](https://tryhackme.com/jr/introtodockerk8pdqk)) should be done.
...
![Kubernetes Orchestration](Images/Kubernetes_Orchestration.png)
...
![The Kubernetes Control Plane](Images/The_Kubernetes_Control_Plane.svg)
...
![Kubernetes Worker Nodes](Images/Kubernetes_Worker_Nodes.svg)
...
![Kubernetes Communication](Images/Kubernetes_Communication.svg)
...
![Kubernetes StatefulSets](Images/Kubernetes_StatefulSets.svg)
...
![Kubernetes Services](Images/Kubernetes_Services.svg)
...
![Kubernetes Configuration](Images/Kubernetes_Configuration.svg)
...
![Kubernetes Security](Images/Kubernetes_Security.png)

#### Kubernetes Hardening

Container hardening is one way in which DevSecOps engineers can secure these channels, and we will dive into that later in this module with the [Container Hardening room](https://tryhackme.com/room/containerhardening). It is the process of using container scanning tools to detect CVEs present in a cluster and remediate them to ensure minimal security breach risk.
...
![Explore Kubernetes](Images/Explore_Kubernetes.png)
...
kube-system   coredns-5dd5756b68-c4gm2           0/1     Running   0          34s
kube-system   etcd-minikube                      1/1     Running   0          46s
kube-system   kube-apiserver-minikube            1/1     Running   0          46s
kube-system   kube-controller-manager-minikube   1/1     Running   0          46s
kube-system   kube-proxy-q5d5m                   1/1     Running   0          34s
kube-system   kube-scheduler-minikube            1/1     Running   0          46s
kube-system   storage-provisioner                1/1     Running   0          43s
ubuntu@tryhackme:~$ 
```
...
ubuntu@tryhackme:~/Desktop/configuration$ cat nginx-deployment.yaml 
apiVersion: apps/v1
kind: Deployment
metadata:
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ cat nginx-service.yaml 
apiVersion: v1
kind: Service
metadata:
  name: nginx-service
...
/home/ubuntu/Documents/app/config/webapp/webapp-config.yaml
ubuntu@tryhackme:~$ cd Desktop/
ubuntu@tryhackme:~/Desktop$ cd configuration/
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ kubectl apply -f nginx-service.yaml 
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ kubectl get pods -A
NAMESPACE     NAME                                READY   STATUS    RESTARTS       AGE
default       nginx-deployment-66d6696594-vnmgc   1/1     Running   0              31s
kube-system   coredns-5dd5756b68-r69bb            1/1     Running   0              9m37s
kube-system   etcd-minikube                       1/1     Running   0              9m49s
kube-system   kube-apiserver-minikube             1/1     Running   0              9m50s
kube-system   kube-controller-manager-minikube    1/1     Running   0              9m49s
kube-system   kube-proxy-tngs5                    1/1     Running   0              9m37s
kube-system   kube-scheduler-minikube             1/1     Running   0              9m49s
kube-system   storage-provisioner                 1/1     Running   1 (9m1s ago)   9m46s
ubuntu@tryhackme:~/Desktop/configuration$ 
```
...
![Kubernetes Interaction](Images/Kubernetes_Interaction.png)
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ kubectl port-forward service/nginx-service 8090:8080
Forwarding from 127.0.0.1:8090 -> 80
Forwarding from [::1]:8090 -> 80

```

Accessing `http://localhost:8090/` in a browser we find

![Login Page at Kubernetes](Images/Login_Page_at_Kubernetes.png)
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ kubectl get secrets
No resources found in default namespace.
ubuntu@tryhackme:~/Desktop/configuration$ kubectl get secrets -A
NAMESPACE     NAME                     TYPE                            DATA   AGE
kube-system   bootstrap-token-qdyrpa   bootstrap.kubernetes.io/token   6      17m
ubuntu@tryhackme:~/Desktop/configuration$ kubectl describe secret terminal-creds
Error from server (NotFound): secrets "terminal-creds" not found
ubuntu@tryhackme:~/Desktop/configuration$ 
```

The configuration seems **broken**!
...
ubuntu@tryhackme:~/Desktop/configuration$ kubectl get configmap webapp-config -o yaml
apiVersion: v1
data:
  index.html: |
    <!DOCTYPE html>
    ...
    <body>
      <div class="login-container">
        <h2>Jurassic Land Terminal Access</h2>
        <form id="loginForm">
      ...
      <script src="jl-login.js"></script>
    </body>
    </html>
  jl-login.js: "function validateLogin() {\n    var username = document.getElementById(\"username\").value;\n
    \   var password = document.getElementById(\"password\").value;\n    var message
    = document.getElementById(\"message\");\n\n    var obfuscatedUsername = String.fromCharCode(65,108,97,110,46,71,114,97,110,116);
    \n    var obfuscatedPassword = String.fromCharCode(68,105,110,48,76,48,118,101,114,53,56);\n\n
    \   if (username === obfuscatedUsername && password === obfuscatedPassword) {\n
    \     message.innerHTML = \"Alan Granted! I mean...Access Granted! \" + atob(\"VEhNe2s4c19rM25ubzFzc2FydXN9\");\n
...
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      {"apiVersion":"v1","data":{"index.html":"\u003c!DOCTYPE html\u003e\n\u003chtml lang=\"en\"\u003e\n\u003chead\u003e\n  \u003cmeta charset=\"UTF-8\"\u003e\n  \u003ctitle\u003eTerminal\u003c/title\u003e\n  \u003clink rel=\"stylesheet\" href=\"styles.css\"\u003e\n\u003c/head\u003e\n\u003cbody\u003e\n  \u003cdiv class=\"login-container\"\u003e\n    \u003ch2\u003eJurassic Land Terminal Access\u003c/h2\u003e\n    \u003cform id=\"loginForm\"\u003e\n      \u003cinput type=\"text\" id=\"username\" placeholder=\"Username\"\u003e\u003cbr\u003e\n      \u003cinput type=\"password\" id=\"password\" placeholder=\"Password\"\u003e\u003cbr\u003e\n      \u003cbutton type=\"button\" onclick=\"validateLogin()\"\u003eSubmit\u003c/button\u003e\n    \u003c/form\u003e\n    \u003cp id=\"message\"\u003e\u003c/p\u003e\n  \u003c/div\u003e\n  \u003cscript src=\"jl-login.js\"\u003e\u003c/script\u003e\n\u003c/body\u003e\n\u003c/html\u003e\n","jl-login.js":"function validateLogin() {\n    var username = document.getElementById(\"username\").value;\n    var password = document.getElementById(\"password\").value;\n    var message = document.getElementById(\"message\");\n\n    var obfuscatedUsername = String.fromCharCode(65,108,97,110,46,71,114,97,110,116); \n    var obfuscatedPassword = String.fromCharCode(68,105,110,48,76,48,118,101,114,53,56);\n\n    if (username === obfuscatedUsername \u0026\u0026 password === obfuscatedPassword) {\n      message.innerHTML = \"Alan Granted! I mean...Access Granted! \" + atob(\"VEhNe2s4c19rM25ubzFzc2FydXN9\");\n      message.style.color = \"green\";\n    } else {\n      message.innerHTML = \"Invalid username or password.\";\n      message.style.color = \"red\";\n    }\n}\n","style.css":"body {\n    font-family: Arial, sans-serif;\n    background-color: #f4f4f4;\n    margin: 0;\n    padding: 0;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 100vh;\n}\n\n.login-container {\n    background-color: #fff;\n    padding: 20px;\n    border-radius: 5px;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n}\n\ninput[type=\"text\"],\ninput[type=\"password\"],\nbutton {\n    margin-bottom: 10px;\n    padding: 8px;\n    width: 100%;\n}\n\nbutton {\n    background-color: #007bff;\n    color: #fff;\n    border: none;\n    cursor: pointer;\n}\n\nbutton:hover {\n    background-color: #0056b3;\n}\n"},"kind":"ConfigMap","metadata":{"annotations":{},"name":"webapp-config","namespace":"default"}}
  creationTimestamp: "2026-02-28T10:33:37Z"
  name: webapp-config
  namespace: default
  resourceVersion: "815"
  uid: b6e3beee-da4e-4838-9603-7c01f47e5b8d
ubuntu@tryhackme:~/Desktop/configuration$ 
```

From these lines we can get the info we need, including the flag:
...
We can use `DevTools` and the `Console` tab in the browser to decode them
...
> obfuscatedPassword
"Din0L0ver58" 
> atob("VEhNe2s4c19rM25ubzFzc2FydXN9");
"THM{<REDACTED>}" 
```
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ kubectl create sa terminal-user
serviceaccount/terminal-user created
ubuntu@tryhackme:~/Desktop/configuration$ kubectl create sa terminal-admin
...
```bash
ubuntu@tryhackme:~/Desktop/configuration$ cd rbac/
ubuntu@tryhackme:~/Desktop/configuration/rbac$ cat role.yaml 
...
```bash
ubuntu@tryhackme:~/Desktop/configuration/rbac$ cat role-binding.yaml 
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
...
```bash
ubuntu@tryhackme:~/Desktop/configuration/rbac$ kubectl apply -f role.yaml 
...
Login with `Alan.Grant:Din0L0ver58` to get the flag
...
Answer: `rbac.authorization.k8s.io/v1`
...
- [Docker - Hoempage](https://www.docker.com/)
