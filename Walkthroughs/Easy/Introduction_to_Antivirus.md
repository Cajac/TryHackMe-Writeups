...
Room link: [https://tryhackme.com/room/introtoav](https://tryhackme.com/room/introtoav)
...
![Antivirus Split Screen](Images/Antivirus_Split_Screen.png)
...
- **Machine IP**: `10.66.184.48`
- **Username**: `thm`
- **Password**: `TryHackM3`

```bash
user@machine$ xfreerdp /v:10.66.184.48 /u:thm /p:TryHackM3
```
...
![Antivirus Static Detection](Images/Antivirus_Static_Detection.png)
...
1. **EICAR** is a test file containing ASCII strings used to test AV software's effectiveness instead of real malware that could damage your machine. For more information, you may visit the official EICAR website here.
...
![HxD Example 1](Images/HxD_Example_1.png)
...
Hint: "C:\Program Files\ClamAV\sigtool.exe" --md5 AV-Check.exe
...
Hint: The flag starts with "THM" characters. You can use findstr to find it: strings <file.exe> | findstr "THM"

```bash
C:\Users\thm\Desktop\Samples>strings -n 8 AV-Check.exe | findstr THM
THM{<REDACTED>}
```
...
![Antivirus Dynamic Detection](Images/Antivirus_Dynamic_Detection.png)
...
![Antivirus Heuristic Detection](Images/Antivirus_Heuristic_Detection.png)
...
![Antivirus Detection Engine](Images/Antivirus_Detection_Engine.png)
...
![VirusTotal Logo](Images/VirusTotal_Logo.png)
...
![Compiling SharpEDRChecker](Images/Compiling_SharpEDRChecker.png)
...
![Compiling Fingerprint](Images/Compiling_Fingerprint.png)
...
![VirusTotal Fingerprint 1](Images/VirusTotal_Fingerprint_1.png)
...
![VirusTotal Fingerprint 2](Images/VirusTotal_Fingerprint_2.png)
...
![VirusTotal Fingerprint 3](Images/VirusTotal_Fingerprint_3.png)
...
- [Anti Malware Testfile - EICAR](https://www.eicar.org/download-anti-malware-testfile/)
...
- [HxD - Homepage](https://mh-nexus.de/en/hxd/)
- [Malware analysis - Wikipedia](https://en.wikipedia.org/wiki/Malware_analysis)
- [SharpEDRChecker - GitHub](https://github.com/PwnDexter/SharpEDRChecker)
