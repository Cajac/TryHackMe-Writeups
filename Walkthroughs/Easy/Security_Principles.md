...
Hint: If you answer a question wrong, you are given a second chance to get it right.
...
- [CIA triad - Wikipedia](https://en.wikipedia.org/wiki/Information_security#CIA_triad)
- [Clark–Wilson model - Wikipedia](https://en.wikipedia.org/wiki/Clark%E2%80%93Wilson_model)
...
- [Threat (computer security) - Wikipedia](https://en.wikipedia.org/wiki/Threat_(computer_security))
