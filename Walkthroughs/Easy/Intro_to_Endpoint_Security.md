...
Room link: [https://tryhackme.com/room/introtoendpointsecurity](https://tryhackme.com/room/introtoendpointsecurity)
...
![TaskManager Example](Images/TaskManager_Example.png)
...
You may refer to the [Core Windows Processes](https://tryhackme.com/room/btwindowsinternals) Room to learn more about this topic.
...
![TCPView Example](Images/TCPView_Example.png)
...
![Process Explorer Example](Images/Process_Explorer_Example.png)
...
![Event Viewer Example](Images/Event_Viewer_Example.png)
...
![Sysmon Events Example](Images/Sysmon_Events_Example.png)
...
![Kolide Fleet Query Example](Images/Kolide_Fleet_Query_Example.png)
...
![Wazuh Example](Images/Wazuh_Example.gif)
