...
Room link: [https://tryhackme.com/room/xss](https://tryhackme.com/room/xss)
...
![Reflected XSS 1](Images/Reflected_XSS_1.png)

The application doesn't check the contents of the error parameter, which allows the attacker to insert malicious code.

![Reflected XSS 2](Images/Reflected_XSS_2.png)

The vulnerability can be used as per the scenario in the image below:

![Reflected XSS Overview](Images/Reflected_XSS_Overview.png)
...
![Stored XSS Overview](Images/Stored_XSS_Overview.png)
...
![DOM Example](Images/DOM_Example.png)

If you want to learn more about the DOM and gain a deeper understanding w3.org have a [great resource](https://www.w3.org/TR/REC-DOM-Level-1/introduction.html).
...
`http://10-10-45-77.reverse-proxy-eu-west-1.tryhackme.com/level1`

Note that HTTP was used (instead of HTTPS) to access the machine.
...
![XSS Practice Level 1](Images/XSS_Practice_Level_1.png)

If you view the Page Source, You'll see your name reflected in the code:

![XSS Practice Level 1b](Images/XSS_Practice_Level_1b.png)
...
![XSS Practice Level 1c](Images/XSS_Practice_Level_1c.png)
...
![XSS Practice Level 2](Images/XSS_Practice_Level_2.png)

Viewing the page source, you can see your name reflected inside the value attribute of the input tag:

![XSS Practice Level 2 Source A](Images/XSS_Practice_Level_2_source_a.png)
...
![XSS Practice Level 2 Source B](Images/XSS_Practice_Level_2_source_b.png)
...
![XSS Practice Level 3](Images/XSS_Practice_Level_3.png)
...
![XSS Practice Level 3 Source A](Images/XSS_Practice_Level_3_Source_A.png)

Into This:

![XSS Practice Level 3 Source B](Images/XSS_Practice_Level_3_Source_B.png)
...
![XSS Practice Level 4 Source A](Images/XSS_Practice_Level_4_Source_A.png)
...
![XSS Practice Level 4 Source B](Images/XSS_Practice_Level_4_Source_B.png)
...
![XSS Practice Level 5 Source A](Images/XSS_Practice_Level_5_Source_A.png)
...
![XSS Practice Level 6 Source A](Images/XSS_Practice_Level_6_Source_A.png)
...
![XSS Practice Level 6 Source B](Images/XSS_Practice_Level_6_Source_B.png)
...
`http://10-10-4-181.reverse-proxy-eu-west-1.tryhackme.com/`
...
![Blind XSS 1](Images/Blind_XSS_1.png)

![Blind XSS 2](Images/Blind_XSS_2.png)
...
![Blind XSS 3](Images/Blind_XSS_3.png)

![Blind XSS 4](Images/Blind_XSS_4.png)
...
Answer: `4AB<REDACTED>321`

For additional information, please see the references below.

## References

- [alert() method - JavaScript - MDN](https://developer.mozilla.org/en-US/docs/Web/API/Window/alert)
- [Base64 - Wikipedia](https://en.wikipedia.org/wiki/Base64)
- [btoa() method - JavaScript - MDN](https://developer.mozilla.org/en-US/docs/Web/API/Window/btoa)
