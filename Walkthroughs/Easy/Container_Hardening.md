...
Room link: [https://tryhackme.com/room/containerhardening](https://tryhackme.com/room/containerhardening)
...
- Practice good hygiene by reviewing Docker images for vulnerabilities
- Implement frameworks and tooling that reviews your code for vulnerabilities.
...
```bash
client@thm:~# docker context create --docker host=ssh://myuser@remotehost --description="Development Environment" development-environment-host 
...
Answer: `docker context create`

#### What would the command be if we wanted to switch to a Docker profile?

```bash
┌──(kali㉿kali)-[/mnt/…/TryHackMe/Walkthroughs/Easy/Container_Hardening]
└─$ docker context -h
...
Hint: If you are stuck, you can look at the example profiles provided in this task.
...
![DockerHub Example 1](Images/DockerHub_Example_1.png)
...
![DockerHub Example 2](Images/DockerHub_Example_2.png)
...
For this answer, be sure to include the full name.
...
```bash
root@thm-container-hardening:~# docker ps
CONTAINER ID   IMAGE                  COMMAND                  CREATED       STATUS         PORTS                                                                                                                             NAMES
0f02452fdc7c   vulhub/couchdb:3.2.1   "/docker-entrypoint.…"   2 years ago   Up 3 minutes   0.0.0.0:4369->4369/tcp, :::4369->4369/tcp, 0.0.0.0:5984->5984/tcp, :::5984->5984/tcp, 0.0.0.0:9100->9100/tcp, :::9100->9100/tcp   couchdb
root@thm-container-hardening:~# 
```
...
Hint: grype imagename --scope all-layers

![Container Hardening 1](Images/Container_Hardening_1.png)
...
Hint: grype /root/container.tar

![Container Hardening 2](Images/Container_Hardening_2.png)
...
- [Seccomp security profiles for Docker - Docker Docs](https://docs.docker.com/engine/security/seccomp/#:~:text=Secure%20computing%20mode%20(%20seccomp%20)%20is,state%20of%20the%20calling%20process.)
